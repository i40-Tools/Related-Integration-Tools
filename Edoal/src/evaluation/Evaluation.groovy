...
public class Evaluation
{
	...
	public void evalResults() {
		testDir = util.ConfigManager.getFilePath() + "Edoal/"
		...
		InserterUtils.loadDelimitedDataTruth(insert, testDir + "edoal.txt")
		...
		resultsFile.append("Fmeasure:" + F1 +  '\n')
		...
		resultsFile.append("Precision :" + precision + '\n')
		resultsFile.append("Recall: " + recall + '\n')
		resultsFile.close()
		resultsDB.close()
		truthDB.close()
	}
