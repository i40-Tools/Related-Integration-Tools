...
public class OWLAPIOntology extends BasicOntology<OWLOntology> implements HeavyLoadedOntology<OWLOntology> {
     ...
     *
     * @param p: the class on which to find cardinality restrictions
     * @return the set of cardinality restrictions
     */
     ...
     *
     * @param cl: the class on which to find cardinality restrictions
     * @return the set of inherited properties of the class
     */
