/*
 * $Id: BasicAlignment.java 2092 2015-11-20 12:03:10Z euzenat $
 *
 ...
 * @version $Id: BasicAlignment.java 2092 2015-11-20 12:03:10Z euzenat $
 */
...
public class BasicAlignment implements Alignment, Extensible {
   ...
   /**
	...
	if ( align instanceof BasicAlignment ) {
	    return ( this.contains( align ) && ((BasicAlignment)align).contains( this ) );
	} else return false;
    }
